...
const productos_t200 = MODELOS_T200.map(n => ({
  ...
  unlock: UNLOCK_T200,
  img: `/images/PUERTAS/AI/door-t200.webp`
}));
...
const productos_k300_max = MODELOS_K300_MAX.map(n => ({
  ...
  img: `/images/PUERTAS/AI/door-k300-max.webp`
}));
...
const productos_k300_pro = MODELOS_K300_PRO.map(n => ({
  ...
  img: `/images/PUERTAS/AI/door-k300-pro.webp`
}));
...
const productos_s121 = MODELOS_S121.map(n => ({
  ...
  unlock: UNLOCK_S121,
  img: `/images/PUERTAS/ACERO/door-s121.webp`
}));
...
const productos_s101 = MODELOS_S101.map(n => ({
  ...
  unlock: UNLOCK_S101,
  img: `/images/PUERTAS/ACERO/door-s101.webp`
}));
...
const productos_s119 = MODELOS_S119.map(n => ({
  ...
  unlock: UNLOCK_S119,
  img: `/images/PUERTAS/ACERO/door-s119.webp`
}));
...
const productos_s118 = ["S118"].map(n => ({
  ...
  img: `/images/PUERTAS/ACERO/door-s118.webp`
}));
...
const productos_s116 = ["S116"].map(n => ({
  ...
  unlock: UNLOCK_S116,
  img: `/images/PUERTAS/ACERO/door-s116.webp`
}));
...
const productos_p103 = ["P103"].map(n => ({
  ...
  unlock: UNLOCK_P103,
  img: `/images/PUERTAS/ACERO/door-p103.webp`
}));
...
const productos_p108 = ["P108"].map(n => ({
  ...
  unlock: UNLOCK_P108,
  img: `/images/PUERTAS/ACERO/door-p108.webp`
}));
...
const productos_p106 = ["P106"].map(n => ({
  ...
  img: `/images/PUERTAS/ACERO/door-p106.webp`
}));
...
const productos_gl097 = ["GL097"].map(n => ({
  ...
  unlock: UNLOCK_GL097,
  img: `/images/PUERTAS/ACERO/door-gl097.webp`
}));
...
const productos_gl097_pro = ["GL097 Pro"].map(n => ({
  ...
  img: `/images/PUERTAS/ACERO/door-gl097-pro.webp`
}));
...
const productos_gl098_pro = ["GL098 Pro"].map(n => ({
  ...
  img: `/images/PUERTAS/ACERO/door-gl098-pro.webp`
}));
...
const productos_cl96 = ["CL96"].map(n => ({
  ...
  unlock: UNLOCK_CL96,
  img: `/images/PUERTAS/ACERO/door-cl96.webp`
}));
...
const productos_cl56 = ["CL56"].map(n => ({
  ...
  features: FEATURES_CL96,
  unlock: UNLOCK_CL96,
  img: `/images/PUERTAS/ACERO/door-cl56.webp`
}));
...
const productos_cl59 = ["CL59"].map(n => ({
  ...
  features: FEATURES_CL96,
  unlock: UNLOCK_CL96,
  img: `/images/PUERTAS/ACERO/door-cl59.webp`
}));
...
const productos_cl66 = ["CL66"].map(n => ({
  ...
  features: FEATURES_CL96,
  unlock: UNLOCK_CL96,
  img: `/images/PUERTAS/ACERO/door-cl66.webp`
}));
...
const productos_n9518 = ["N9518"].map(n => ({
  ...
  unlock: UNLOCK_N9518,
  img: `/images/PUERTAS/ACERO/door-n9518.webp`
}));
...
const productos_n9519 = ["N9519"].map(n => ({
  ...
  img: `/images/PUERTAS/ACERO/door-n9519.webp`
}));
...
const productos_ia = MODELOS_IA.map(n => {
  ...
  if (n === "X50 Max") {
    return {
      ...
      img: `/images/PUERTAS/AI/door-x50-max.webp`
    };
  }
  ...
  if (n === "X60 Max") {
    return {
      ...
      unlock: UNLOCK_X70,
      img: `/images/PUERTAS/AI/door-x60-max.webp`
    };
  }
  ...
  if (n === "X70 Shunliu") {
    return {
      ...
      features: FEATURES_X70,
      unlock: UNLOCK_X70,
      img: `/images/PUERTAS/AI/door-x70-shunliu.webp`
    };
  }
  ...
  if (n === "X70 Jinxiu") {
    return {
      ...
      features: FEATURES_X70,
      unlock: UNLOCK_X70,
      img: `/images/PUERTAS/AI/door-x70-jinxiu.webp`
    };
  }
  ...
  return {
    ...
    unlock: UNLOCK_IA,
    img: `/images/PUERTAS/AI/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
  };
});
...
const productos_acero = MODELOS_ACERO.map(n => ({
  ...
  img: `/images/PUERTAS/ACERO/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_acorazada = MODELOS_ACORAZADA.map(n => ({
  ...
  specs: SPECS_MECANICA, features: FEATURES_MECANICA, unlock: UNLOCK_MECANICO,
  img: `/images/PUERTAS/ACORAZADA/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_aluminio = MODELOS_ALUMINIO.map(n => ({
  ...
  img: `/images/PUERTAS/ALUMINIO/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_madera_j = MODELOS_MADERA_J.map(n => ({
  ...
  img: `/images/PUERTAS/MADERAACÚSTICA/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_minimalista_ume = MODELOS_MINIMALISTA_UME.map(n => ({
  ...
  img: `/images/PUERTAS/MINIMALISTA/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_bajo_carbono = MODELOS_BAJO_CARBONO.map(n => ({
  ...
  img: `/images/PUERTAS/BAJOCARBONO/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_pvc = MODELOS_PVC.map(n => ({
  ...
  img: `/images/PUERTAS/PVC/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_corredizas = MODELOS_CORREDIZAS.map(n => {
  ...
  return {
    ...
    colors: colors,
    img: `/images/PUERTAS/CORREDIZA/door-${n}.webp`
  };
});
...
const productos_cortafuegos = MODELOS_CORTAFUEGOS.map(n => ({
  ...
  img: `/images/PUERTAS/CORTAFUEGO/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_evacuacion = MODELOS_EVACUACION.map(n => ({
  ...
  img: `/images/PUERTAS/EVACUACION/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_medicas = MODELOS_MEDICAS.map(n => ({
  ...
  img: `/images/PUERTAS/MEDICA/door-${n.toLowerCase().replace(/\s+/g, '-')}.webp`
}));
...
const productos_n9520 = ["N9520"].map(n => ({
  ...
  unlock: UNLOCK_N9520,
  img: `/images/PUERTAS/ACERO/door-n9520.webp`
}));
...
const productos_y118 = ["Y118"].map(n => ({
  ...
  unlock: UNLOCK_Y118,
  img: `/images/PUERTAS/ACERO/door-y118.webp`
}));
...
const productos_y116 = ["Y116"].map(n => ({
  ...
  features: FEATURES_Y118,
  unlock: UNLOCK_Y118,
  img: `/images/PUERTAS/ACERO/door-y116.webp`
}));
...
const productos_y119 = ["Y119"].map(n => ({
  ...
  unlock: UNLOCK_Y119,
  img: `/images/PUERTAS/ACERO/door-y119.webp`
}));
...
const productos_y106 = ["Y106"].map(n => ({
  ...
  unlock: UNLOCK_Y106,
  img: `/images/PUERTAS/ACERO/door-y106.webp`
}));
...
const productos_chaohe = ["Chaohe"].map(n => ({
  ...
  img: `/images/PUERTAS/ALUMINIO/door-chaohe.webp`
}));
...
const productos_l5859 = ["L5859"].map(n => ({
  ...
  unlock: UNLOCK_L5859,
  img: `/images/PUERTAS/AI/door-l5859.webp`
}));
...
const productos_l5857 = ["L5857"].map(n => ({
  ...
  img: `/images/PUERTAS/AI/door-l5857.webp`
}));
...
const productos_l5601 = ["L5601"].map(n => ({
  ...
  img: `/images/PUERTAS/ACERO/door-l5601.webp`
}));
...
const productos_luyi = ["Louis"].map(n => ({
  ...
  unlock: UNLOCK_LUYI,
  img: `/images/PUERTAS/ALUMINIO/door-luyi.webp`
}));
...
const productos_chaopu = ["Chaopu"].map(n => ({
  ...
  img: `/images/PUERTAS/ALUMINIO/door-chaopu.webp`
}));
...
const productos_dihua = ["Dihua"].map(n => ({
  ...
  unlock: UNLOCK_DIHUA,
  img: `/images/PUERTAS/ALUMINIO/door-dihua.webp`
}));
...
const productos_saina = ["Saina"].map(n => ({
  ...
  img: `/images/PUERTAS/ALUMINIO/door-saina.webp`
}));
...
const productos_makailen = ["Makailen"].map(n => ({
  ...
  img: `/images/PUERTAS/ALUMINIO/door-makailen.webp`
}));
...
const productos_sabo = ["Sabo"].map(n => ({
  ...
  unlock: UNLOCK_SABO,
  img: `/images/PUERTAS/ALUMINIO/door-sabo.webp`
}));
...
const productos_chaoling = ["Chaoling"].map(n => ({
  ...
  img: `/images/PUERTAS/ALUMINIO/door-chaoling.webp`
}));
...
const productos_pulada = ["Pulada"].map(n => ({
  ...
  img: `/images/PUERTAS/ALUMINIO/door-pulada.webp`
}));
...
const productos_tdf2009 = ["TDF-2009"].map(n => ({
  ...
  img: `/images/PUERTAS/COBRE/door-tdf-2009.webp`
}));
...
const productos_tdf2003 = ["TDF-2003"].map(n => ({
  ...
  img: `/images/PUERTAS/COBRE/door-tdf-2003.webp`
}));
...
const productos_shengshi = ["Shengshi"].map(n => ({
  ...
  img: `/images/PUERTAS/ALUMINIO/door-shengshi.webp`
}));

// ---- LINGAN ----
const SPECS_LINGAN = [
  { label: "Nivel", value: "Antirrobo Nivel 4" },
  { label: "Grosor", value: "90mm" },
  { label: "Cerradura", value: "Antiexplosión Doble Acción y Doble Velocidad / Con Placa Decorativa Principal y Secundaria" },
  { label: "Núcleo", value: "Cilindro Eléctrico Antipalanca de Tres Filas" },
  { label: "Cerradura IA", value: "Manilla Inteligente con Huella y Teclado" },
  { label: "Medidas", value: "A Medida / No Estándar" }
];

const FEATURES_LINGAN = [
  "Seguridad antirrobo nivel 4",
  "Cuerpo de acero de 90mm de grosor",
  "Cerradura antiexplosión de doble acción y doble velocidad con placa decorativa doble",
  "Cilindro eléctrico antipalanca de tres filas",
  "Manilla inteligente con huella y teclado",
  "Diseño minimalista con bloques de color y filo dorado",
  "Fabricación a medida no estándar"
];

const UNLOCK_LINGAN = "Huella / Contraseña / Tarjeta / App / Llave";

const productos_lingan = ["Lingan"].map(n => ({
  name: n,
  category: "PUERTA DE ACERO REFORZADO",
  description: "Puerta de seguridad inteligente modelo Lingan. Nivel antirrobo 4 con cuerpo de acero de 90mm, cerradura antiexplosión de doble acción y cerradura inteligente. Diseño minimalista en gris antracita y nogal con filo dorado.",
  specs: SPECS_LINGAN,
  features: FEATURES_LINGAN,
  unlock: UNLOCK_LINGAN,
  img: `/images/PUERTAS/ACERO/door-lingan.webp`
}));
...
const DATA_PRODUCTOS = [
  ...
  ...productos_s101, ...productos_s116, ...productos_s118, ...productos_s119, ...productos_p103, ...productos_p106, ...productos_p108, ...productos_gl097, ...productos_gl097_pro, ...productos_gl098_pro, ...productos_cl56, ...productos_cl59, ...productos_cl66, ...productos_cl96, ...productos_n9518, ...productos_lingan, ...productos_acero,
