    ...
    useEffect(() => {
        ...
        async function fetchSillas() {
            ...
            try {
                ...
                if (error.name !== 'AbortError') console.error("Error cargando sillas:", error.message);
            } finally {
                setIsLoading(false);
            }
        }
            ...
            <div className="container mx-auto px-4 md:px-6 py-6 md:py-12" ref={gridTopRef}>
                {isLoading ? (
                    ...
                    <div className="text-center py-32 text-gray-400 flex flex-col items-center">
                        ...
                        <p className="text-lg">No encontramos sillas.</p>
                        <button onClick={() => { setSearchTerm(""); setActiveColor(null); setActiveMaterial(null); handleCategoryChange("Todos"); }}
