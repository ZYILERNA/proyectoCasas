...
const factoryModules = [
  {
    ...
    icon: <Bot size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Scan size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Cpu size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Warehouse size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Factory size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Paintbrush size={24} className="text-[#D4A868]"/>,
    ...
    <div className="bg-[#050505] text-white overflow-hidden font-sans">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            <span className="inline-block py-1 px-3 rounded border border-[#D4A868]/30 bg-[#D4A868]/10 text-[#D4A868] text-xs font-mono mb-4 tracking-widest backdrop-blur-md">
              EST. 1996 // GRUPO WANGLI · SSE 605268
            </span>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
              Liderazgo a <br/>
              <span className="block mt-6 text-transparent bg-clip-text bg-gradient-to-r from-[#D4A868] to-white">
                Escala Global
              </span>
            </h1>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                <div className="text-[#D4A868] mb-3">{s.icon}</div>
      ...
      <section className="py-24 container mx-auto px-6 relative">
        {/* Decoración de fondo */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#D4A868] opacity-[0.02] blur-[100px] rounded-full pointer-events-none"/>

        <div className="mb-12">
           <span className="inline-block text-xs font-bold uppercase tracking-[0.25em] text-[#D4A868] mb-4">Perfil Corporativo</span>
           <h2 className="text-3xl md:text-4xl font-bold mb-4">El Poder de la <span className="text-[#D4A868]">Integración</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
          ...
          >
             ...
             <div className="absolute inset-0 bg-gradient-to-t from-[#050505] via-[#050505]/60 to-transparent p-8 md:p-12 flex flex-col justify-end">
                <div className="flex gap-3 mb-4">
                  <span className="bg-[#D4A868] text-black text-xs font-bold px-3 py-1 rounded shadow-lg">
                    24 FEB 2021
                  </span>
          ...
          >
            ...
            <div className="bg-[#111] border border-white/10 rounded-2xl p-8 flex-1 group hover:border-white/20 transition-colors">
               <div className="flex items-center justify-between mb-6">
                 ...
                 <Factory className="text-[#D4A868] opacity-50" size={24}/>
               </div>
          ...
          >
             <div>
               <h4 className="text-lg text-[#D4A868] font-bold mb-2 tracking-wide uppercase text-sm">Confianza Gubernamental e Institucional</h4>
          ...
          <motion.div 
            ...
            className="col-span-1 lg:col-span-4 bg-[#111] border border-[#D4A868]/20 rounded-2xl p-8 relative overflow-hidden flex flex-col justify-center"
          >
             <div className="absolute -right-6 -bottom-6 opacity-10">
               <ShieldCheck size={120} className="text-[#D4A868]"/>
             </div>
             <h4 className="text-5xl font-mono font-bold text-white mb-2">1,000+</h4>
             <p className="text-lg font-bold text-[#D4A868] mb-1">Patentes Nacionales</p>
      ...
      <section className="py-20 bg-[#070707] relative border-t border-white/5 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#D4A868]/5 blur-[140px] pointer-events-none" />
        <div className="container mx-auto px-6 relative z-10">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            <span className="inline-block text-xs font-bold uppercase tracking-[0.25em] text-[#D4A868] mb-4">
              En Movimiento
            </span>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Descubre <span className="text-[#D4A868]">WONLY</span> en Vídeo
            </h2>
      ...
      <section className="py-20 bg-[#0A0A0A] relative border-t border-white/5">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center max-w-4xl mx-auto">
            <span className="inline-block text-xs font-bold uppercase tracking-[0.25em] text-[#D4A868] mb-4">Industria 4.0</span>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Fabricación <span className="text-[#D4A868]">Inteligente</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {factoryModules.map((item, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
                viewport={{ once: true }}
                className="group bg-[#111] border border-white/10 rounded-xl overflow-hidden hover:border-[#D4A868]/50 transition-colors duration-300"
              >
                <div className="h-48 overflow-hidden relative">
                  ...
                  />
                  <div className="absolute top-3 right-3 bg-black/80 backdrop-blur-sm px-3 py-1 text-xs font-bold text-[#D4A868] rounded border border-[#D4A868]/20">
                    {item.stats}
                  </div>
                </div>
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="p-2 bg-[#D4A868]/10 rounded-lg">
                      {item.icon}
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                  <div className="h-px w-12 bg-[#D4A868]"></div>
                  <span className="text-[#D4A868] font-bold tracking-widest text-sm uppercase">Innovación Constante</span>
              </div>
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                  {["Yongkang", "Wuyi", "Sichuan", "Hangzhou", "Hubei"].map((city) => (
                    <span key={city} className="px-4 py-2 bg-[#111] border border-white/10 rounded-full text-sm text-gray-300 flex items-center gap-2">
                      <MapPin size={14} className="text-[#D4A868]"/> {city}
                    </span>
                  ))}
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative group overflow-hidden rounded-xl col-span-2 h-48 border border-white/10">
                ...
                <div className="absolute bottom-0 w-full bg-black/80 backdrop-blur-sm py-3 px-4 flex justify-between items-center">
                  ...
                  <Star size={16} className="text-[#D4A868]"/>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-24 bg-[#111] relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-[#D4A868] opacity-[0.03] blur-[120px] rounded-full pointer-events-none"/>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4A868] to-white">
                los Estándares
              </span>
            </motion.h2>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="absolute left-[20px] md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-transparent via-[#D4A868]/50 to-transparent md:-translate-x-1/2"></div>
            ...
            <ol>
              {wonlyMilestones.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute left-[20px] md:left-1/2 w-4 h-4 bg-[#D4A868] rounded-full border-4 border-black shadow-[0_0_15px_rgba(212,168,104,0.8)] z-10 md:-translate-x-1/2 transform -translate-x-1/2 mt-1.5 md:mt-0"></div>

                  <div className="w-full md:w-1/2 pl-16 md:pl-0 md:px-12">
                     <div className={`flex flex-col ${index % 2 === 0 ? "md:items-start md:text-left" : "md:items-end md:text-right"}`}>
                        <time dateTime={item.year} className="text-5xl md:text-6xl font-bold text-white/10 mb-2 font-mono tracking-tighter">
                          {item.year}
                        </time>
                        <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#D4A868] transition-colors">
                          {item.title}
                        </h3>
      ...
      {/* =========================================================
         ...
         ========================================================= */}
      <section className="relative py-24 md:py-32 bg-[#0A0908] overflow-hidden border-t border-white/10">
        ...
        />
          ...
          <div className="absolute bottom-0 w-full h-40 bg-gradient-to-t from-[#0D0C0A] to-transparent z-10"></div>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10 h-full flex items-center">
          ...
          <div className="w-full lg:w-3/5 max-w-2xl">
            ...
            >
              ...
              <div className="space-y-6 mb-16 border-l-2 border-[#D4A868] pl-6">
                <div>
                  <p className="text-white font-bold text-xl md:text-2xl mb-1">200 Millones+ de Usuarios Globales</p>
                  <p className="text-gray-400 text-sm">Servicio acumulado durante 30 años de excelencia.</p>
                </div>
      ...
      {/* =========================================================
         ...
         ========================================================= */}
      <div className="w-full bg-[#0D0C0A] py-8 flex justify-center items-center relative z-20">
         <div className="w-1/3 h-px bg-gradient-to-r from-transparent via-[#D4A868]/30 to-transparent"></div>
      </div>

      {/* =========================================================
          8. TOP 500 ASIAN BRANDS (Diseño Ciudad)
         ========================================================= */}
      <section className="relative h-screen min-h-[600px] flex items-center justify-center lg:justify-end overflow-hidden bg-[#0D0C0A]">
        
        {/* FONDO DE CIUDAD CON EL 500 DORADO */}
        <div className="absolute inset-0 z-0">
          {/* NUEVO: Degradado superior para suavizar la entrada de la imagen */}
          <div className="absolute top-0 w-full h-32 bg-gradient-to-b from-[#0D0C0A] to-transparent z-10 pointer-events-none"></div>
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-r from-[#0D0C0A]/90 lg:from-transparent via-[#0D0C0A]/40 lg:via-transparent to-[#0D0C0A]/90 lg:to-[#0D0C0A]/80"></div>
        </div>
      ...
      {/* =========================================================
         ...
         ========================================================= */}
      <section className="relative py-24 lg:py-32 min-h-[80vh] flex items-center overflow-hidden bg-[#0D0C0A]">
        {/* FONDO EDIFICIOS */}
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#0D0C0A]/95 via-[#0D0C0A]/80 to-[#0D0C0A]/20 z-0"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
                Reconocido por <br/>
                <span className="text-[#D4A868]">12 años consecutivos</span> <br/>
              ...
              <div className="w-12 h-1 bg-[#D4A868] mb-6"></div>
      ...
      <section className="relative py-24 border-t border-white/10 overflow-hidden bg-[#111]">
         ...
         <div className="container mx-auto px-6 text-center relative z-10">
            ...
            <Link 
            href="/contacto" 
            className="bg-white text-black px-8 py-4 rounded-full font-bold hover:bg-[#D4A868] hover:text-black transition-all duration-300 shadow-[0_0_30px_rgba(212,168,104,0.3)] hover:shadow-[0_0_40px_rgba(212,168,104,0.6)]">
