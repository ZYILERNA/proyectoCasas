...
const cookieSections = [
  {
    ...
    icon: <Cookie size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <ShieldCheck size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <BarChart3 size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Target size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Globe size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Trash2 size={24} className="text-[#D4A868]"/>,
    ...
    <div className="bg-[#050505] text-white overflow-hidden font-sans min-h-screen">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#D4A868] opacity-[0.04] blur-[120px] rounded-full" />
        </div>
      ...
      <div className="border-b border-white/10 bg-[#111] py-3 overflow-hidden relative">
        <div className="flex gap-8 md:gap-12 items-center justify-center opacity-70 font-mono text-xs md:text-sm whitespace-nowrap overflow-x-auto px-4">
           ...
           <span className="w-1 h-1 bg-gray-500 rounded-full"/>
           <span className="text-[#D4A868]">CONTROL DE USUARIO</span>
        </div>
      </div>
      ...
      <section className="py-20 container mx-auto px-6 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {cookieSections.map((section, index) => (
            <motion.div
              ...
              className="group bg-[#111] border border-white/10 rounded-2xl p-8 hover:border-[#D4A868]/30 transition-colors duration-300 relative overflow-hidden flex flex-col h-full"
            >
              <div className="absolute top-0 right-0 w-48 h-48 bg-[#D4A868] opacity-0 group-hover:opacity-[0.03] blur-[60px] transition-opacity duration-500 rounded-full pointer-events-none" />
        ...
        <div className="mt-10 rounded-2xl border border-white/10 bg-[#111] p-6 md:p-8">
          ...
          <dl className="mt-5 grid gap-4 text-sm md:grid-cols-3">
            <div>
              <dt className="font-mono text-xs text-[#D4A868]">wonly_cookie_consent</dt>
            ...
            <div>
              <dt className="font-mono text-xs text-[#D4A868]">googtrans</dt>
              <dd className="mt-2 leading-relaxed text-gray-400">
                Cookie funcional de sesión. Solo se crea al solicitar una traducción con Google Translate.
              </dd>
            </div>
            <div>
              <dt className="font-mono text-xs text-[#D4A868]">wonly_admin_session</dt>
              <dd className="mt-2 leading-relaxed text-gray-400">
      ...
      <section className="py-16 bg-[#0a0a0a] border-t border-white/10">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <div className="inline-flex p-4 bg-white/5 rounded-full mb-6">
            <SlidersHorizontal className="text-[#D4A868]" size={32}/>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button 
                className="inline-flex items-center justify-center gap-2 bg-[#D4A868] text-black px-8 py-4 rounded-full font-bold hover:bg-white transition-all duration-300"
            ...
            <Link 
              href="/contacto" 
              className="inline-flex items-center justify-center gap-2 bg-[#111] border border-white/20 text-white px-8 py-4 rounded-full font-bold hover:border-[#D4A868] hover:text-[#D4A868] transition-all duration-300"
            >
      ...
      <section className="relative py-20 border-t border-white/10 overflow-hidden bg-[#050505]">
         <div className="absolute inset-0 opacity-20 pointer-events-none">
            <div className="absolute left-0 top-0 w-[500px] h-[500px] bg-[#D4A868] blur-[150px] rounded-full mix-blend-screen"/>
         </div>
