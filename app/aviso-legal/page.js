...
const legalSections = [
  ...
  },
  {
    id: "usuarios",
    title: "2. Usuarios",
    icon: <FileText size={24} className="text-[#00C2FF]"/>,
  ...
  },
  {
    ...
    icon: <Copyright size={24} className="text-[#00C2FF]"/>,
  ...
  },
  {
    ...
    icon: <AlertTriangle size={24} className="text-[#00C2FF]"/>,
  ...
  },
  {
    ...
    icon: <Lock size={24} className="text-[#00C2FF]"/>,
    ...
    <div className="bg-[#050505] text-white overflow-hidden font-sans min-h-screen">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#00C2FF] opacity-[0.05] blur-[120px] rounded-full" />
        </div>
      ...
      <div className="border-b border-white/10 bg-[#111] py-3 overflow-hidden relative">
        <div className="flex gap-8 md:gap-12 items-center justify-center opacity-70 font-mono text-xs md:text-sm whitespace-nowrap overflow-x-auto px-4">
           ...
           <span className="w-1 h-1 bg-gray-500 rounded-full"/>
           <span className="text-[#00C2FF]">TÉRMINOS DE USO</span>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-8">
          {legalSections.map((section, index) => (
            <motion.div
              ...
              className="group bg-[#111] border border-white/10 rounded-2xl p-6 md:p-10 hover:border-[#00C2FF]/30 transition-colors duration-300 relative overflow-hidden"
            >
              {/* Efecto hover suave en el fondo */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#00C2FF] opacity-0 group-hover:opacity-[0.02] blur-[80px] transition-opacity duration-500 rounded-full pointer-events-none" />
