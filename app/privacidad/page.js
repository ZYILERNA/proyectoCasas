...
const privacySections = [
  {
    ...
    icon: <Database size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Fingerprint size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <ShieldAlert size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Share2 size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <UserCheck size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <Clock size={24} className="text-[#D4A868]"/>,
  ...
  },
  {
    ...
    icon: <LockKeyhole size={24} className="text-[#D4A868]"/>,
    ...
    <div className="bg-[#050505] text-white overflow-hidden font-sans min-h-screen">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#D4A868] opacity-[0.06] blur-[130px] rounded-full" />
        </div>
      ...
      <div className="border-b border-white/10 bg-[#111] py-3 overflow-hidden relative">
        <div className="flex gap-8 md:gap-12 items-center justify-center opacity-70 font-mono text-xs md:text-sm whitespace-nowrap overflow-x-auto px-4">
           ...
           <span className="w-1 h-1 bg-gray-500 rounded-full"/>
           <span className="text-[#D4A868]">CONTACTO DIRECTO</span>
        </div>
      </div>
